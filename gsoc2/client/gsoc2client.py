...
from gsoc2.api import create_api_request_with_auth
from gsoc2.constants import (
    AUTH_MODE_SERVICE_TOKEN,
    AUTH_MODE_SERVICE_TOKEN_V3,
    GSOC2_URL,
    SERVICE_TOKEN_REGEX,
)
from gsoc2.exceptions import Gsoc2TokenError
from gsoc2.helpers.client import (
...
from gsoc2.models.secret_service import ClientConfig
...
class Gsoc2Client:
    def __init__(
        ...
        if token and token != "":
            ...
            if token_match is None:
                raise Gsoc2TokenError("The token is not in correct format!")
    ...
    def get_all_secrets(
        ...
        """Return all the secrets accessible by the instance of Gsoc2"""
